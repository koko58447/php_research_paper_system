...
<title>Internet Service Plan | teacher</title>
<!-- start page content -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Save New Teacher</h4>
                    ...
                    <div class="row">                        
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="staffname" class="form-control" placeholder="Enter Teacher Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="startdt" class="form-control" placeholder="Enter start date"
                                    value="<?php echo date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="rmk" class="form-control" placeholder="Enter Remark">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Edit Teacher</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
...
$(document).ready(function() {
    ...
    $("#frmedit").on("submit", function(e) {
        e.preventDefault();
        var formData = new FormData(this);     
        var staffname = $("[name='staffname1']").val();
        var nrc = $("[name='nrc1']").val();
        var dept = $("[name='dept1']").val();
        var salary = $("[name='salary1']").val();
        if (staffname == '' || nrc == '' || dept == '' || salary == '') {
    ...
    $(document).on("click", "#btnchangeimage", function(e) {      
        var aid = $(this).data("aid");
        ...
        if (path == '') {
            ...
            aa = "<?php echo roothtml.'upload/staff/teacher/' ?>" + path;
        }
    ...
    $(document).on("click", "#btnpublication", function(e) {      
        var aid = $(this).data("aid");
        ...
        $.ajax({
            ...
            success: function(data) {
                location.href="<?php echo roothtml.'teacher/edit_publication.php' ?>";
            }
        });

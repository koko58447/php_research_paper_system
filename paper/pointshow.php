    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Point Show</div>
                </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>
                            <div class="btn-group">
                                <form method="POST" action="pointshow_action.php">
...
$(document).ready(function() {
    ...
    $(document).on("click", "#btndetail", function() {
        ...
        window.location.href="<?php echo roothtml.'paper/detail.php?aid=' ?>"+aid+"&sname="+sname+"&name="+pname+"&sid="+sid;

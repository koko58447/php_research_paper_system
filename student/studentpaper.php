    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Student Paper</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><i class="fa fa-users"></i>&nbsp;<a class="parent-item"
                            href="<?php echo roothtml.'student/student.php' ?>">Student</a>&nbsp;<i
                            class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">Student Paper</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>
                            <div class="btn-group">
                                <form method="POST" action="studentpaper_action.php">
